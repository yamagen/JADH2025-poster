...
%  \textbf{\fontsize{40pt}{30pt}\selectfont Introduction}\\[1em]
  \textcolor{katanoBrown}{
    \begin{itemize}
      \item Ise Monogatari: A classic of Japanese literature established in CA. 10th century, Heian period.
...
\begin{lstlisting}[language=json]
{
  ...
  "translation-en": "While out hunting, he encountered [him], and on the road took hold of the horse's bridle, saying, 'This is what I think.' Feeling moved, [he] came and lay down [with her].",
  "phrase-gloss": [
...
\node[
  ...
  align=center,
  inner sep=20pt,
  font=\fontsize{56pt}{56pt}\bfseries
] at ([xshift=51cm,yshift=2cm]json.north west)
{
...
%------------------------------------
% 付箋ノード No. 8 Interpretation is not translation.
\node[
  draw,
  fill=yellow!20,
  align=left,
...
%  align=center,
  inner sep=20pt,
  font=\fontsize{42pt}{42pt}\bfseries
] at ([xshift=27cm,yshift=-75cm]json.north west)
{
\ifENG
  \textcolor{blue}{If it is necessary, interpretation can be written in notes-ja/en.}
\else
  \jpfont 
  \textcolor{blue}{解釈はノートになら、書いてもよい。}
\fi
};


%------------------------------------
% 付箋ノード No. 9 Do not translate in detail.
\node[
  draw,
  fill=pink!20,
  align=left,
...
%------------------------------------
% 付箋ノード No. 8 Zenodo QR code: Tale of Ise
\node[
%  draw,
%  fill=blue!20,
  align=left,
...
%  text width=39cm,
  ...
  inner sep=10pt,
  font=\fontsize{58pt}{58pt}\bfseries
] at ([xshift=-13cm,yshift=-75cm]json.north east)
{
\includegraphics[width=6cm]{images/qrZenodoIse.png}
\includegraphics[width=6cm]{images/qrGithubIse.png}
\includegraphics[width=6cm]{images/qrGithubPosterJADH2025.png}
};
...
%------------------------------------
% キャラクター画像 kaukau what? onionboy.png
\node[left=-40cm of json, yshift=13cm] (char05) {
\reflectbox{ \includegraphics[width=11cm]{images/onionboy.png}}
};
% 雲型吹き出し
\node[
  right=-14.5cm of char05, 
  yshift=1.2cm,
  rectangle callout,
  rounded corners=15pt, 
  callout relative pointer={(1.3cm,-.2cm)},
%  anchor=south east,
  draw,
  fill=white,
  text width=5cm,
...
\node[
  ...
  text=mydeepblue,
  font=\fontsize{30pt}{20pt}\bfseries
] (conclusionbox) at ([xshift=4cm, yshift=-101.5cm]current page.north west) {
